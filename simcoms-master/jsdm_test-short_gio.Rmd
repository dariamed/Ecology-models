...
paramX <- hm_mod$results$estimation$paramX[,,i]

res[,,i]<-tcrossprod(data$X,paramX)

postBeta1 = array(unlist(mod$postList[[1]],getOmega),c(3,ns,mod$samples))
postBeta2 = array(unlist(lapply(mod$postList[[2]],getOmega)),c(ns,ns,mod$samples))

...
pred_j<-pnorm(predict_y_jsdm(me20))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
...
pred_j<-pnorm(predict_y_jsdm(mfd5))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
...
pred_j<-pnorm(predict_y_jsdm(mfd10))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
...
pred_j<-pnorm(predict_y_jsdm(mfd20))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
...
pred_j<-pnorm(predict_y_jsdm(mfs10))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
...
pred_j<-pnorm(predict_y_jsdm(mfs20))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
...
pred_j<-pnorm(predict_y_jsdm(mcmpd5))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
...
mod_list_Tau<-list(jsdm =mcmpd10$mean$Rho*(!mcmpd10$overlap0$Rho))  
 ##Prediction
pred_j<-pnorm(predict_y_jsdm(mcmpd10))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
...
mod_list_Tau<-list(jsdm =mcmpd20$mean$Rho*(!mcmpd20$overlap0$Rho)) 
 ...
 pred_j<-pnorm(predict_y_jsdm(mcmpd20))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
...
####Prediction  
pred_j<-pnorm(predict_y_jsdm(cmps5))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
...
###Prediction  
pred_j<-pnorm(predict_y_jsdm(cmps10))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
pred_jsdm<-list(pred_j_mean=pred_j_mean,pred_j_05=pred_j_05,pred_j_95=pred_j_95)
...
pred_j<-pnorm(predict_y_jsdm(cmps20))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
...
###Prediction
pred_j<-pnorm(predict_y_jsdm(cmp_fd5))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
...
pred_j<-pnorm(predict_y_jsdm(cmp_fd10))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
...
pred_j<-pnorm(predict_y_jsdm(cmp_fd20))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
...
##Prediction
pred_j<-pnorm(predict_y_jsdm(cmp_fds5))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
pred_jsdm<-list(pred_j_mean=pred_j_mean,pred_j_05=pred_j_05,pred_j_95=pred_j_95)
...
########Prediction
pred_j<-pnorm(predict_y_jsdm(cmp_fds10))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)
...
pred_j<-pnorm(predict_y_jsdm(cmp_fds20))
pred_j_mean <- apply(pred_j, 1:2, mean)
pred_j_05 <- apply(pred_j, 1:2, quantile,0.05)
pred_j_95 <- apply(pred_j, 1:2, quantile,0.95)

...
gjam_dim_red_5<-function(datab,ng=2500, burnin=500){
  ...
  gjam_mc_nd<- mcmc(mod_gjam_red$chains$sgibbs) 
  hist(effectiveSize(gjam_mc_nd), main="ess(sigma)",lwd=2,col=gray(.6),breaks=100)
  return(list(Rho_sign_d=Sigma_sign,Tau_sign_d=INVSigma_sign,  k=mod_gjam_red$chains$kgibbs))
}
...
```{r gjam en20 dim red, include=TRUE, echo=FALSE}
# 
# data<-sim_data$EnvEvenSp20
# 

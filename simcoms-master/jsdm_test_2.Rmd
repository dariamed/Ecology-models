...
#fit_gjam(data,10000,1500,"./gjam_models/gjam20sd.rda",interact=fac_inter[[9]])
...
hm_mod<-fit_hmsc(data,"Load",name="./HMmodels/hm20fs.rda" )
hm_conv(hm_mod)
hm_inter(hm_mod, interact = fac_inter[[9]])
...
fit_gjam(data,5000,500,"./gjam_models/gjam5cmpd.rda",interact=comp_inter[[10]])

#load_gjam(data,name="./gjam_models/gjam5cmpd.rda", interact=,interact=comp_inter[[10]])
...
hm_mod<-fit_hmsc(data,"Fit",name="./HMmodels/hm5cmpd.rda" )
hm_conv(hm_mod)
hm_inter(hm_mod, interact = comp_inter[[10]])
...
load_gjam(data,name="./gjam_models/gjam10cmpd.rda", interact=comp_inter[[11]])
...
```{r hmsc cmpd10}
data<-sim_data$CompDenseSp10
hm_mod<-fit_hmsc(data,"Load",name="./HMmodels/hm10cmpd.rda" )
hm_conv(hm_mod)
hm_inter(hm_mod, interact = comp_inter[[11]])
...
#Tau_n<-to_prec(mfd10$mean$Tau)
plot_cor_jsdm(mcmpd20,data$Y,comp_inter[[12]])
```
...
#fit_gjam(data,5000,500,"./gjam_models/gjam20cmpd.rda",interact=comp_inter[[12]])

load_gjam(data,name="./gjam_models/gjam20cmpd.rda", interact=fac_inter[[6]])
...
hm_mod<-fit_hmsc(data,"Load",name="./HMmodels/hm20cmpd.rda" )
hm_conv(hm_mod)
hm_inter(hm_mod, interact = comp_inter[[12]])

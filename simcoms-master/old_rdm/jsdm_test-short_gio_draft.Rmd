...
pred_me5<-pnorm(predict_y_jsdm(me5))


pred_me5_mean <- apply(pred_me5, 1:2, mean)

pred_me5_05 <- apply(pred_me5, 1:2, quantile,0.05)
pred_me5_95 <- apply(pred_me5, 1:2, quantile,0.95)
...
pred_gj_mu <- mod_gjam$predict$sdList$yMu
pred_gj_05 <- mod_gjam$predict$piList$yLo
pred_gj_95 <- mod_gjam$predict$piList$yLo
...
pred_hm_mean <- apply(pred_me5, c(1,2), mean)
pred_hm_05 <- apply(pred_me5, c(1,2), quantile,0.05)
pred_hm_95 <- apply(pred_me5, c(1,2), quantile,0.95)
...
#fundamental niche
# nspecies<-5
# niche_optima  = seq(2, 98, nspecies)
# niche_breadth = 20
# for(i in 1:nspecies)
#   assign(paste0("fund_sp_",i),dnorm(1)
# 

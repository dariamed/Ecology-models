...
gjam_dim_red_5<-function(datab,ng=2500, burnin=500){
  ...
  hist(effectiveSize(gjam_bs), main="ess(beta)",lwd=2,col=gray(.6),breaks=20)
  hist(gelman.diag(gjam_bs, multivariate=FALSE)$psrf,lwd=2,col=gray(.6), main="psrf(beta)")
  #gelman.plot(gjam_bs)
  #xyplot(gjam_bs)
  #traceplot(gjam_sigma)
 ...
 # gjam_mc_nd<- mcmc(mod_gjam_red_1$chains$sgibbs) 
  #hist(effectiveSize(gjam_mc_nd), main="ess(sigma)",lwd=2,col=gray(.6),breaks=100)
  return(list(Rho_sign_d=Sigma_sign,Tau_sign_d=INVSigma_sign,k=kgibbs))
}
...
gjam_dim_red<-function(datab,ng=2500, burnin=500,r=1){
  ...
  invsigma_q95<-apply(invsigma,c(1,2),quantile,0.95) 
  INVSigma_sign<--cov2cor(sigma_mean*(!(invsigma_q95>0 & invsigma_q05<0)))
  return(list(Rho_sign_d=Sigma_sign,Tau_sign_d=INVSigma_sign,r_opt=r, k=kgibbs ))
}
#r-opt=7
...
AUCs<-list(AUC_j_env=AUC_j_env,AUC_g_env=AUC_g_env,AUC_h_env=AUC_h_env,
           AUC_j_fac_dense=AUC_j_fac_dense,AUC_g_fac_dense=AUC_g_fac_dense,AUC_h_fac_dense=AUC_h_fac_dense,
           AUC_j_fac_sparse=AUC_j_fac_sparse,AUC_g_fac_sparse=AUC_g_fac_sparse,AUC_h_fac_sparse=AUC_h_fac_sparse,
           AUC_j_comp_dense=AUC_j_comp_dense,AUC_g_comp_dense=AUC_g_comp_dense,AUC_h_comp_dense=AUC_h_comp_dense,
           AUC_j_comp_sparse=AUC_j_comp_sparse,AUC_g_comp_sparse=AUC_g_comp_sparse,AUC_h_comp_sparse=AUC_h_comp_sparse,
           AUC_j_comp_fac_dense=AUC_j_comp_fac_dense,AUC_g_comp_fac_dense=AUC_g_comp_fac_dense,AUC_h_comp_fac_dense=AUC_h_comp_fac_dense,
           AUC_j_comp_fac_sparse=AUC_j_comp_fac_sparse,AUC_g_comp_fac_sparse=AUC_g_comp_fac_sparse,AUC_h_comp_fac_sparse=AUC_h_comp_fac_sparse)

...
theta<-1
alpha<- seq(0.1,0.97, by=0.001)
k<- 50
f<- (gamma(theta)*gamma(theta/alpha + k*alpha/(1-alpha)))/(gamma(theta/alpha)*gamma(theta + k*alpha/(1-alpha)))
...
k<- 50
f<- (gamma(theta/alpha + k*alpha/(1-alpha))/gamma(theta + k*alpha/(1-alpha)))

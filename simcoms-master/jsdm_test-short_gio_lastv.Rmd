...
data<-sim_data$EnvEvenSp5
#mod_gjam<-fit_gjam(data,4000,1000,name="./gjam_models/gjam5env.rda")
mod_gjam<-load_gjam(data,4000,1000,name="./gjam_models/gjam5env.rda")
...
gjam_dim_red_5<-function(datab,ng=2500, burnin=500,name="./gjam_models/tmpdr.rda", regime="L"){
  ...
  if(regime=="L"){
    ...
    mod_gjam_red_1<-gjam_dr_mods$mod_gjam1
    mod_gjam_red_2<-gjam_dr_mods$mod_gjam2
  }else{
      mod_gjam_red_1 <- gjam(formula, xdata, ydata, modelList = ml)
      mod_gjam_red_2 <- gjam(formula, xdata, ydata, modelList = ml)
      gjam_dr_mods<- list(m1=mod_gjam1,m2=mod_gjam2)
...
S<- gjam_dim_red_5(sim_data$EnvEvenSp5,ng=10000, burnin=1000, name="./gjam_models/gjamDR5env.rda", regime="F")
...
create_plot_response(data=sim_data$EnvEvenSp5, nsp=5,pred_gjam, pred_jsdm,pred_hmsc,pred_gjam_dr)
...
#######
create_beta_plot(load_object("./gjam_models/gjam5env.rda"),me5,hmmod=load_object("./HMmodels/hm5env.rda"), S$bchain)
...
gjam_mod<-load_gjam(data,it=3000,500,name="./gjam_models/gjam10env.rda")
...
S<- gjam_dim_red(sim_data$EnvEvenSp10,ng=2500, burnin=500,r=7, name="./gjam_models/gjamDR10env.rda", regime="L")
...
create_beta_plot(load_object("./gjam_models/gjam10env.rda"),me10,load_object("./HMmodels/hm10env.rda"), S$bchain)
#data, nsp=5,pred_gjam, pred_jsdm,pred_hmsc 
create_plot_response(data=sim_data$EnvEvenSp10, nsp=10,pred_gjam, pred_jsdm,pred_hmsc,pred_gjam_dr )
...
#r-opt=15
S<- gjam_dim_red(sim_data$EnvEvenSp20,ng=2500, burnin=500,r=15, name="./gjam_models/gjamDR20env.rda", regime="F")


##Prediction
pred_gj_mean <-apply(S$predict, 1:2,mean)
pred_gj_05 <- apply(S$predict, 1:2,quantile,0.05)
pred_gj_95 <- apply(S$predict, 1:2,quantile,0.95)
data<-sim_data$EnvEvenSp5 
for(i in 1:(ncol(data)-1)) AUC_gdr_env<-c(AUC_gdr_env,auc(roc(pred_gj_mean[,i],factor(data[,i]))))

pred_gjam_dr<- list(pred_gj_dr_mean=pred_gj_mean,pred_gj_dr_05=pred_gj_05,pred_gj_dr_95=pred_gj_95)
...
S<- gjam_dim_red_5(sim_data$FacDenseSp5,ng=5500, burnin=1000, name="./gjam_models/gjamDR5facd.rda", regime="L")
...
pred_gj_95 <- apply(S$predict, 1:2,quantile,0.95)
data<-sim_data$EnvEvenSp5 
for(i in 1:(ncol(data)-1)) AUC_gdr_fac_dense<-c(AUC_gdr_fac_dense,auc(roc(pred_gj_mean[,i],factor(data[,i]))))
...
data<-sim_data$FacDenseSp10
#gjam_mod<-fit_gjam(data,5000,500,"./gjam_models/gjam10fd.rda",interact=fac_inter[[5]])
...
#r-opt=7
S<- gjam_dim_red(sim_data$FacDenseSp10,ng=2500, burnin=500,r=7, name="./gjam_models/gjamDR10facd.rda", regime="L")
pg<- comp.psm(S$k)
...
#r-opt=15
S<- gjam_dim_red(sim_data$FacDenseSp20,ng=2500, burnin=500,r=15, name="./gjam_models/gjamDR20facd.rda", regime="L")
##Prediction
pred_gj_mean <-apply(S$predict, 1:2,mean)
pred_gj_05 <- apply(S$predict, 1:2,quantile,0.05)
pred_gj_95 <- apply(S$predict, 1:2,quantile,0.95)
...
data<-sim_data$FacSparseSp5
#gjam_mod<-fit_gjam(data,2500,500,"./gjam_models/gjam5fs.rda",interact=fac_inter[[7]])
...
S<- gjam_dim_red_5(sim_data$FacSparseSp5,ng=2500, burnin=1000, name="./gjam_models/gjamDR5facs.rda", regime="L")
...
pred_gj_95 <- apply(S$predict, 1:2,quantile,0.95)
data<-sim_data$EnvEvenSp5 
for(i in 1:(ncol(data)-1)) AUC_gdr_fac_sparse<-c(AUC_gdr_fac_sparse,auc(roc(pred_gj_mean[,i],factor(data[,i]))))
...
data<-sim_data$FacSparseSp10
#gjam_mod<-fit_gjam(data,4000,1000,"./gjam_models/gjam10fs.rda",interact=fac_inter[[8]])
...
#r-opt=5
S<- gjam_dim_red(sim_data$FacSparseSp10,ng=2500, burnin=500,r=5, name="./gjam_models/gjamDR10facs.rda", regime="L")
...
#r-opt=15
S<- gjam_dim_red(sim_data$FacSparseSp20,ng=2500, burnin=500,r=15, name="./gjam_models/gjamDR20facs.rda", regime="L")
...
S<- gjam_dim_red_5(sim_data$CompDenseSp5,ng=2500, burnin=1000, name="./gjam_models/gjamDR10env.rda", regime="L")
...
pred_gj_95 <- apply(S$predict, 1:2,quantile,0.95)
data<-sim_data$EnvEvenSp5 
for(i in 1:(ncol(data)-1)) AUC_gdr_comp_dense<-c(AUC_gdr_comp_dense,auc(roc(pred_gj_mean[,i],factor(data[,i]))))
...
data<-sim_data$CompDenseSp10
#gjam_mod<-fit_gjam(data,5000,1000,"./gjam_models/gjam10cmpd.rda",interact=comp_inter[[11]])
gjam_mod<-load_gjam(data,5000,1000,name="./gjam_models/gjam10cmpd.rda", interact= (-1)*comp_inter[[11]])
...
#r-opt=5
S<- gjam_dim_red(sim_data$CompDenseSp10,ng=2500, burnin=500,r=5)
...
#r-opt=15
S<- gjam_dim_red(sim_data$CompDenseSp20,ng=2500, burnin=500,r=15)
...
data<-sim_data$CompSparseSp5
#gjam_mod<-fit_gjam(data,5000,2000,"./gjam_models/gjam5cmps.rda",interact= (-1)*comp_inter[[13]])
...
S<- gjam_dim_red_5(sim_data$CompSparseSp5,ng=2500, burnin=1000)
...
pred_gj_95 <- apply(S$predict, 1:2,quantile,0.95)
data<-sim_data$EnvEvenSp5 
for(i in 1:(ncol(data)-1)) AUC_gdr_comp_sparse<-c(AUC_gdr_comp_sparse,auc(roc(pred_gj_mean[,i],factor(data[,i]))))
...
data<-sim_data$CompSparseSp10
#gjam_mod<-fit_gjam(data,2000,500,"./gjam_models/gjam10cmps.rda",interact= (-1)*comp_inter[[14]])
...
#r-opt=5
S<- gjam_dim_red(sim_data$CompSparseSp10,ng=2500, burnin=500,r=5)
...
data<-sim_data$CompSparseSp20
#gjam_mod<-fit_gjam(data,2000,500,"./gjam_models/gjam20cmps.rda",interact= (-1)*comp_inter[[15]])
...
#r-opt=13
S<- gjam_dim_red(sim_data$CompSparseSp20,ng=2500, burnin=500,r=13)
...
S<- gjam_dim_red_5(sim_data$FacCompDenseSp5,ng=2500, burnin=1000)
...
pred_gj_95 <- apply(S$predict, 1:2,quantile,0.95)
data<-sim_data$EnvEvenSp5 
for(i in 1:(ncol(data)-1)) AUC_gdr_comp_fac_dense<-c(AUC_gdr_comp_fac_dense,auc(roc(pred_gj_mean[,i],factor(data[,i]))))
...
data<-sim_data$FacCompDenseSp10
#gjam_mod<-fit_gjam(data,2000,500,"./gjam_models/gjamcmp_facd10.rda",interact=  (-1)*comp_inter[[17]]+fac_inter[[17]])
...
#r-opt=5
S<- gjam_dim_red(sim_data$FacCompDenseSp10,ng=2500, burnin=500,r=5)
...
data<-sim_data$FacCompDenseSp20
#gjam_mod<-fit_gjam(data,5000,1000,"./gjam_models/gjamcmp_facd20.rda",interact=  (-1)*comp_inter[[18]]+fac_inter[[18]])
gjam_mod<-load_gjam(data,5000,1000,name="./gjam_models/gjamcmp_facd20.rda", interact= (-1)*comp_inter[[18]]+fac_inter[[18]])
...
#r-opt=5
S<- gjam_dim_red(sim_data$FacCompDenseSp20,ng=2500, burnin=500,r=15)
...
data<-sim_data$FacCompSparseSp5
#gjam_mod<-fit_gjam(data,5000,1000,"./gjam_models/gjamcmp_facs5.rda",interact= (-1)*comp_inter[[19]]+ fac_inter[[19]] )
gjam_mod<-load_gjam(data,5000,1000,name="./gjam_models/gjamcmp_facs5.rda", interact=  (-1)*comp_inter[[19]]+ fac_inter[[19]])
...
```{r dimred compfacd5, include=TRUE,echo=FALSE}

S<- gjam_dim_red_5(sim_data$FacCompSparseSp5,ng=2500, burnin=1000)
...
pred_gj_95 <- apply(S$predict, 1:2,quantile,0.95)
data<-sim_data$EnvEvenSp5 
for(i in 1:(ncol(data)-1)) AUC_gdr_comp_fac_sparse<-c(AUC_gdr_comp_fac_sparse,auc(roc(pred_gj_mean[,i],factor(data[,i]))))
...
data<-sim_data$FacCompSparseSp10
#gjam_mod<-fit_gjam(data,4000,1000,"./gjam_models/gjamcmp_facs10.rda",interact= (-1)*comp_inter[[20]] +fac_inter[[20]])
gjam_mod<-load_gjam(data,4000,1000,name="./gjam_models/gjamcmp_facs10.rda", interact=  (-1)*comp_inter[[20]] +fac_inter[[20]])
...
#r-opt=5
S<- gjam_dim_red(sim_data$FacCompSparseSp10,ng=2500, burnin=500,r=5)
...
data<-sim_data$FacCompSparseSp20
gjam_mod<-fit_gjam(data,4000,1000,"./gjam_models/gjamcmp_facs20.rda",interact= (-1)*comp_inter[[21]]+fac_inter[[21]])
gjam_mod<-load_gjam(data,4000,1000,name="./gjam_models/gjamcmp_facs20.rda", interact= (-1)*comp_inter[[21]]+fac_inter[[21]])
...
#r-opt=15
S<- gjam_dim_red(sim_data$FacCompSparseSp20,ng=2500, burnin=500,r=15)
...
for(i in 1:length(AUCs)){
  ...
  if(length(grep("_j_",names(AUCs)[[i]]))>0)  table[(k+1):(k+length(AUCs[[i]])),"Model"]<-rep("JSDM",length(AUCs[[i]]))
  
  if(length(grep("_g_",names(AUCs)[[i]]))>0)  table[(k+1):(k+length(AUCs[[i]])),"Model"]<-rep("GJAM",length(AUCs[[i]]))
  if(length(grep("_gdr_",names(AUCs)[[i]]))>0)  table[(k+1):(k+length(AUCs[[i]])),"Model"]<-rep("GJAM_DR",length(AUCs[[i]]))
...
table[nrow(table)+1,]<-c(-1,"JSDM", "Env","Dense")
table[nrow(table)+1,]<-c(-1,"GJAM", "Env","Dense")
table[nrow(table)+1,]<-c(-1,"GJAM_DR", "Env","Dense")
table[nrow(table)+1,]<-c(-1,"HMSC", "Env","Dense")

p<-ggplot(data=table)+geom_boxplot(aes(y=as.numeric(AUC),x=Filtering,fill=Model,color=Density),position = position_dodge(1,preserve = "single"))+
  ylim(c(0,1)) +scale_colour_manual(name = as.character(levels(as.factor(table$Density))),values = c('black','purple'))+
  theme_tufte()

...
sdm_env5<-predict_sdm_bayes(sim_data$EnvEvenSp5)
...
sdm_env10<-predict_sdm_bayes(sim_data$EnvEvenSp10)
...
sdm_env20<-predict_sdm_bayes(sim_data$EnvEvenSp20)
...
sdm_envfcd5<-predict_sdm_bayes(sim_data$FacDenseSp5)
...
sdm_envfcd10<-predict_sdm_bayes(sim_data$FacDenseSp10)
...
sdm_envfcd20<-predict_sdm_bayes(sim_data$FacDenseSp20)
...
sdm_envfcs5<-predict_sdm_bayes(sim_data$FacSparseSp5)
...
sdm_envfcs10<-predict_sdm_bayes(sim_data$FacSparseSp10)
...
sdm_envfcs20<-predict_sdm_bayes(sim_data$FacSparseSp20)
...
sdm_envcmpd5<-predict_sdm_bayes(sim_data$CompDenseSp5)
...
sdm_envcmpd10<-predict_sdm_bayes(sim_data$CompDenseSp10)
...
sdm_envcmpd20<-predict_sdm_bayes(sim_data$CompDenseSp20)
...
sdm_envcmps5<-predict_sdm_bayes(sim_data$CompSparseSp5)
...
sdm_envcmps10<-predict_sdm_bayes(sim_data$CompSparseSp10)
...
corrplot(comp.psm(S$k), diag = FALSE, order = "original",tl.pos = "ld", tl.cex = 0.5, method = "color",col=gcols(200),cl.lim=c(0, 1), type = "lower")
title("Partial Correlation from dimension reduction")
corrplot((-1)*comp_inter[[15]], diag = FALSE, order = "original",tl.pos = "ld", tl.cex = 0.5, method = "color",col=cols(200), type = "lower")
title("True interactions")
...
sdm_envcmps20<-predict_sdm_bayes(sim_data$CompSparseSp20)
...
sdm_envcmfd5<-predict_sdm_bayes(sim_data$FacCompDenseSp5)
...
sdm_envcmfd10<-predict_sdm_bayes(sim_data$FacCompDenseSp10)
...
sdm_envcmfd20<-predict_sdm_bayes(sim_data$FacCompDenseSp20)
...
sdm_envcmfs5<-predict_sdm_bayes(sim_data$FacCompSparseSp5)
...
sdm_envcmfs10<-predict_sdm_bayes(sim_data$FacCompSparseSp10)
...
sdm_envcmfs20<-predict_sdm_bayes(sim_data$FacCompSparseSp20)
